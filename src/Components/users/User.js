...
const User = ({ match }) => {
    ...
    // if we didnt add dependency then useEffect will go in infinite loop
    // hence add empty array as depedency
    // to avoid warning missing dependencies add line eslint-disable-next-line
